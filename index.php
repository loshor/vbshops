				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>где купить vb?<br>
							 чтоб тебя не обманули и не забанили?На PS,PC</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								 мы новая командда которая работает через VK!У нас низкие цены и быстрая работа!По всем вопросам отвечаем очень быстро.
							<a>
							<div class='landing-btn-container'>
								<div class="build-btn-button">
									...
									<a href="https://vk.com/public217598559" target="_blank">
									<span>купить "Vb" снизу<span>
									</div>
									</a>
								</div>
							</div>
				...
				<div class="search-con-inner">
					<div class="search-inp-search darkmode-search-border">
						...
						<div class="search-con-author darkmode-txt">
							<a href="https://vk.com/public217598559" target="_blank">
							<span class="darkmode-txt">мы всегда в онлайн  <span class="search-img-author"></span>
							<span class="search-tx1-author">VK</span>
							</span>
							</a>
						</div>
	...
	<div class="landing-con-video darkmode-feature">
		<div class="content-con-outside">
			...
			<div class="content-con-inside">
				...
				<img src="https://cdn2.unrealengine.com/social-image-chapter4-3840x2160-e1951132b132.jpg" height="600px">
			</div>
		</div>
	</div>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
								Присоеденяйся мы там кайфуем!Там будет многое.От общения до розогрышей!Мы очень будем рады если на нашем DS канале будет много людей!каждые 5000тыщ=розогрыш на 10 боевых пропусков!
								</p>
							</div>
							<a href="https://discord.com/channels/1050078115789033584/1050078116632076379" target="_blank">
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							...
							<div class="github-tx2-mantra darkmode-txt">
								<p>
								Как купить в-баксы и как их использовать есть в нашей группе ВК.У нас очень добрые модераторы.Иногда даже они бесплатно дают коды)У меня за спиной!Внизу есть кнопочка на которую можно потыкать.Она раслобляет?
								</p>
							</div>
